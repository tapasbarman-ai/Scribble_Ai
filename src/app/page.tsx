...
export default function GamePage() {
  ...
  return (
    <div className="flex flex-col flex-grow p-4 md:p-6 w-full max-w-[1400px] mx-auto min-h-screen">
      ...
      {banner && (
        <div 
          className={`fixed bottom-6 right-6 z-[1000] p-4 border-[3px] border-slate-900 border-radius-btn shadow-flat flex items-center gap-3 font-heading text-lg font-bold text-white transition-all transform animate-slideInLeft ${
            banner.type === "success" ? "bg-[#33cc66]" :
